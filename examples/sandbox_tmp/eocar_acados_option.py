...
def prepare_ocp(biorbd_model_path, final_time, number_shooting_points, nb_threads, solver):
    # --- Options --- #
...
if __name__ == "__main__":
    ocp = prepare_ocp(
        biorbd_model_path="../eocar/eocar-6D.bioMod", final_time=2, number_shooting_points=31,nb_threads=4, solver='acados')

    # --- Solve the program --- #
    sol = ocp.solve(solver='acados')
